      ...
      <div className="wp-root">
        ...
        <main className="wp-main">
          ...
          <article className="wp-section" id="s08">
            ...
            <p>Myndzprint generates revenue through two distinct channels: a consumer subscription business and an enterprise contracts business. They serve different customers and operate on different economics, but they reinforce each other. The consumer side builds brand, library depth, and proof of concept. The enterprise side builds revenue, margin, and scale.</p>

            <h3 className="wp-sub-label">B2C — Individual Consumers</h3>
            <p>Individual users access Myndzprint through a freemium subscription model. The free tier provides limited access to the mind library to lower the barrier to entry and build habit. Paid tiers unlock the full experience.</p>

            <table className="wp-b2b-table">
              <tbody>
                <tr>
                  <td>Free</td>
                  <td>Limited conversations per month with any mind in the public library. No account required to browse; light registration to converse. Designed to demonstrate value before asking for payment.</td>
                </tr>
                <tr>
                  <td>Pro — $12/month</td>
                  <td>Unlimited conversations across the full library. Ability to build and publish personal minds. Persistent conversation memory. Early access to new minds as they launch. The target subscription for serious individual users.</td>
                </tr>
                <tr>
                  <td>Creator — $29/month</td>
                  <td>Everything in Pro, plus tools to publish minds publicly and earn revenue when others use them. Designed for thought leaders, educators, and professionals who want to monetise their expertise at scale.</td>
                </tr>
              </tbody>
            </table>

            <p>Consumer revenue compounds as the library grows. More minds attract more users; more users generate more conversations; more conversations validate and improve the minds. The subscription base also de-risks the business: predictable monthly revenue that does not depend on closing enterprise deals.</p>

            <h3 className="wp-sub-label">B2B — Enterprise and Institutional</h3>
            <p>The enterprise business operates on annual contracts and is where the majority of Myndzprint&rsquo;s long-term revenue will be generated. Organisations pay for the ability to build private minds from their own people and material, deploy them internally or externally, and manage access across teams.</p>

            <table className="wp-b2b-table">
              <tbody>
                <tr>
                  <td>Internal Knowledge</td>
                  <td>Organisations build minds from founders, senior staff, and internal documentation. New hires onboard faster. Critical institutional knowledge is preserved when key people leave. Priced per mind built and per seat accessing them.</td>
                </tr>
                <tr>
                  <td>Customer-Facing Deployment</td>
                  <td>Companies deploy minds as customer-facing AI: a mind that thinks like their best advisor, support lead, or product expert. Grounded in the organisation&rsquo;s actual content. Priced on a usage and deployment basis.</td>
                </tr>
                <tr>
                  <td>Education Licensing</td>
                  <td>Universities and schools license access to the Myndzprint library and mind-building tools for curriculum integration. Students converse with the thinkers they are studying. Priced per institution on an annual basis.</td>
                </tr>
                <tr>
                  <td>Community and Media</td>
                  <td>Publishers, newsletters, and community platforms publish minds of their contributors and experts. Readers access the thinking of writers and leaders directly. Priced on a white-label or revenue-share basis.</td>
                </tr>
              </tbody>
            </table>

            <div className="wp-pull-quote"><p>Consumer subscriptions build the brand. Enterprise contracts build the business. Both need the other to work.</p></div>

            <p>The two revenue streams are structurally complementary. Enterprise clients want a proven platform with an active user base. Consumer users trust a platform that serious organisations already use. Each validates the other.</p>
          </article>
